...
public class MaterialBagInv extends GameField {
	...
	public MaterialBagInv(MaterialBag bag, Game game, int savefile) {
					...
					for(int y = 0; y < bag.inventory.length/width; y++){
						...
						if(r.contains(mx, my)){
							if(bag.inventory[x+y*width]!=null){
								...
								try{
									bag.inventory[x+y*width]=(MatStack)Mouse.Item;Mouse.Item = null;
